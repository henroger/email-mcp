...
def send_email(
    ...
    api_url = f"http://saas-send-api.eks.instanthrive.com/send_email"
...
def main():
    ...
    html_path = Path("sample_email.html")
    ...
    try:
        send_email(
            api_key = "1234567890",
            recipients = ["henryy@gmail.com", "henry.yao@newsbreak.com"],
            subject = "Test Email",
            html_body = html,
